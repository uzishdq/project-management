...
export default function SideBar() {
  ...
  const sidebarClassName = `fixed flex flex-col h-[100%] justify-beetwen shadow-xl transition-all duration-300 h-full z-40 dark:bg-black overflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
